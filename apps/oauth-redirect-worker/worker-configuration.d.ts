/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=.generated/wrangler.jsonc` (hash: 0aa4ad9c520fd0def3fdd9095c7ebefd)
// Runtime types generated with workerd@1.20260609.1 2025-06-17
interface __BaseEnv_Env {
	AUTH_REDIRECT_CONFIG: "{\"redirects\":{\"allowLocalhost\":true,\"allowedHostPatterns\":[\"*.plansombl.com\",\"*.ensombl.io\",\"*.certless.io\"],\"forwardedCallbackParams\":[\"code\",\"state\",\"scope\",\"iss\",\"session_state\",\"error\",\"error_description\",\"error_uri\"],\"stripTargetParams\":[\"redirect\",\"redirect_uri\",\"return_to\",\"returnTo\",\"next\",\"url\",\"destination\",\"continue\",\"goto\",\"target\",\"forward\",\"callback\"],\"maxStateLength\":4096,\"maxFinalUrlLength\":4096}}";
}
